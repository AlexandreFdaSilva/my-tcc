            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section>
                        ...
                        <form method="post" action="{{ route('molecules.update', [$molecule]) }}" class="mt-6 space-y-6"
                            ...
                            <div>
                                ...
                                <select id="status" name="status"
                                    ...
                                    @foreach ($statuses as $statusKey => $statusValue)
                                        <option @if ($statusKey == $molecule->status) @selected(true) @endif
                                            value="{{ $statusKey }}">{{ $statusValue }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                    required autofocus autocomplete="name" value="{{ $molecule->name }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="class" name="class" type="text" class="mt-1 block w-full"
                                    autofocus autocomplete="class" value="{{ $molecule->class }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="formula" name="formula" type="text" class="mt-1 block w-full"
                                    autofocus autocomplete="formula" value="{{ $molecule->formula }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="smiles" name="smiles" type="text" class="mt-1 block w-full"
                                    autofocus autocomplete="smiles" value="{{ $molecule->smiles }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="inchi" name="inchi" type="text" class="mt-1 block w-full"
                                    autofocus autocomplete="inchi" value="{{ $molecule->inchi }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="iupac" name="iupac" type="text" class="mt-1 block w-full"
                                    autofocus autocomplete="iupac" value="{{ $molecule->iupac }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="x_log_p" name="x_log_p" type="text" class="mt-1 block w-full"
                                    autofocus autocomplete="x_log_p" value="{{ $molecule->x_log_p }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="monoisotopic_mass" name="monoisotopic_mass" type="text"
                                    ...
                                    value="{{ $molecule->monoisotopic_mass }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="tpsa" name="tpsa" type="text" class="mt-1 block w-full"
                                    autofocus autocomplete="tpsa" value="{{ $molecule->tpsa }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="charge" name="charge" type="text" class="mt-1 block w-full"
                                    autofocus autocomplete="charge" value="{{ $molecule->charge }}" />
